...
<div class="d-flex rounded" style="background-color: #a5bdcc;">
        ...
        <div class="mb-3">
            ...
            <div class="d-flex justify-content-end m-2">
                <form class="d-flex" role="search">
                    <input onkeyup="check_for_enter_key(event)" oninput="search_item(event)" type="text" class="form-control js-search" placeholder="Search Product..." aria-label="Search Product..." aria-describedby="basic-addon1" style="border-color: blue;">
    ...
    <div class="col-3 bg-light p-4 pt-2">
        <h2 class="text-center"><i class="bi bi-cart-plus"></i> Cart <div class="js-item-count badge bg-secondary rounded-circle text-white">0</div>
        </h2>
