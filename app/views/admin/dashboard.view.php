...
<div class="graph-container">
	...
	// Check if $today_records is an array before calling daily_sales_data
	if (is_array($today_records) && !empty($today_records)) {
		...
		echo '<div style="font-size: 1.5em; color: #888; text-align: center;">No data available for today.</div>';
	}
	?>
</div>
