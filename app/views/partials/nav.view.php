<nav class="navbar navbar-expand-lg" style="min-inline-size:350px; background-color: #2C3E50; ">
    <div class="container-fluid shadow-sm">
        <img src="assets/img/BTP.jpg" height="60px" width="60x" class="ps-1 ms-4 my-2 img-fluid">
